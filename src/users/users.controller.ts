import { Body, Controller, HttpStatus, Patch, Post, Put, Res } from '@nestjs/common';
...
export class UsersController {
  ...
  @Patch('activate')
  async activateUser(@Body() activateUserDTO: ActivateUserDTO, @Res() res: Response) {
    try {
      const User = await this.usersServices.activateUser(activateUserDTO)
